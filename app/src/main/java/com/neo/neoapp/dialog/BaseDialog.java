...
public class BaseDialog extends Dialog implements
	...
	private NeoBasicTextView mHtvTitle;// 标题
	private View mViewTitleLine;// 标题分割线
	private LinearLayout mLayoutContent;// 内容根布局
	private NeoBasicTextView mHtvMessage;// 内容
	...
	private void initViews() {
		...
		mHtvTitle = (NeoBasicTextView) findViewById(R.id.dialog_generic_htv_title);
		...
		mHtvMessage = (NeoBasicTextView) findViewById(R.id.dialog_generic_htv_message);
