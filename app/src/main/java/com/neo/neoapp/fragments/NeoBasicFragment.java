...
public abstract class NeoBasicFragment extends Fragment {
	...
	public NeoBasicFragment() {
		super();
	}

	public NeoBasicFragment(NeoBasicApplication application, Activity activity,
			Context context) {
