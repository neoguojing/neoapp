...
import com.neo.neoapp.UI.adapters.EmoteAdapter;
...
public class EmoteInputView extends LinearLayout implements OnClickListener,
	...
	public void init() {
		...
		mDefaultAdapter = new EmoteAdapter(getContext(),
				NeoBasicApplication.mEmoticons_Zem);
		//mEmojiAdapter = new EmoteAdapter(getContext(),
				//NeoBasicApplication.mEmoticons_Zemoji);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (mIsSelectedDefault) {
			text = NeoBasicApplication.mEmoticons_Zem.get(arg2);
		} else {
			//text = NeoBasicApplication.mEmoticons_Zemoji.get(arg2);
		}
