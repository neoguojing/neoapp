package com.neo.neoapp.UI.views.list;
...
import com.neo.neoapp.UI.views.NeoRotateAnimation;
...
public class NeoRefreshListView extends NeoBasicListView {
	...
	private NeoBasicTextView mHtvTitle;
	private NeoBasicTextView mHtvTime;
	...
	public NeoRefreshListView(Context context) {
		super(context);
		init();
	}

	public NeoRefreshListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public NeoRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	...
	private void init() {
		mHeader = mInflater.inflate(R.layout.include_pull_to_refreshing_header,
				null);
		mHtvTitle = (NeoBasicTextView) mHeader
				.findViewById(R.id.refreshing_header_htv_title);
		mHtvTime = (NeoBasicTextView) mHeader
		...
		mPullAnimation = new android.view.animation.RotateAnimation(0, -180,
				NeoRotateAnimation.RELATIVE_TO_SELF, 0.5f,
				NeoRotateAnimation.RELATIVE_TO_SELF, 0.5f);
