...
public abstract class NeoBasicListView extends ListView implements
	OnScrollListener {
	...
	public NeoBasicListView(Context context) {
		super(context);
		init(context);
	}
	
	public NeoBasicListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}
	
	public NeoBasicListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
