...
import com.neo.neoapp.UI.views.RoundImageView;
import com.neo.neoapp.UI.views.UserPhotosView;
import com.neo.neoapp.UI.views.UserPhotosView.onPagerPhotoItemClickListener;
...
public class PeopleDetailActivity extends NeoBasicActivity implements
	...
	private NeoBasicTextView mHtvAge;// 年龄
	private NeoBasicTextView mHtvConstellation;// 星座
	private NeoBasicTextView mHtvDistance;// 距离
	private NeoBasicTextView mHtvTime;// 时间
	...
	private NeoBasicTextView mHtvFeedSignature;// 状态签名
	private NeoBasicTextView mHtvFeedDistance;// 状态距离
	...
	private People mPeople;// 用户实体
	private PeopleProfile mProfile;// 资料
	...
	protected void initViews() {
		...
		mHtvAge = (NeoBasicTextView) findViewById(R.id.otherprofile_htv_age);
		mHtvConstellation = (NeoBasicTextView) findViewById(R.id.otherprofile_htv_constellation);
		mHtvDistance = (NeoBasicTextView) findViewById(R.id.otherprofile_htv_distance);
		mHtvTime = (NeoBasicTextView) findViewById(R.id.otherprofile_htv_time);
		...
		mHtvFeedSignature = (NeoBasicTextView) findViewById(R.id.otherprofile_htv_feed_sign);
		mHtvFeedDistance = (NeoBasicTextView) findViewById(R.id.otherprofile_htv_feed_distance);
	...
	public void onClick(View v) {
		...
		case R.id.otherprofile_bottom_layout_chat:
			intent = new Intent(PeopleDetailActivity.this, ChatActivity.class);
	...
	private void initJoinGroup() {
		View group = LayoutInflater.from(PeopleDetailActivity.this).inflate(
		...
		NeoBasicTextView mHtvOwner = (NeoBasicTextView) group
