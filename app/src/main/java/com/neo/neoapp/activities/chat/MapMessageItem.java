...
import com.neo.neoandroidlib.ImageMapUtils;
import com.neo.neoandroidlib.ImageMapUtils.OnMapDownloadStateListener;
...
public class MapMessageItem extends MessageItem implements OnClickListener,
	...
	public MapMessageItem(Message msg, Context context) {
		super(msg, context);
		mApplication = ((NeoBasicApplication) ((Activity) mContext)
				.getApplication());
