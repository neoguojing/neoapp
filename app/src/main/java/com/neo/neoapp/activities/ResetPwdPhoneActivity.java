...
public class ResetPwdPhoneActivity extends NeoBasicActivity implements
		OnClickListener {

	private HeaderLayout mHeaderLayout;
	private NeoBasicTextView mHtvContent;
	...
	protected void initViews() {
		...
		mHtvContent = (NeoBasicTextView) findViewById(R.id.resetpwdphone_htv_content);
